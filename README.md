...
A curated list of exceptional libraries, harnesses, and skills for AI agent development and orchestration.

## 🚀 Web Portal
The project features a clean, interactive web portal to browse, search, and filter libraries by category and tag.
To open the portal, simply serve the files locally or open `index.html` in your browser.

## 📚 Curated Libraries

### Agent Harnesses & Frameworks
* **[awesome-agent-harness](https://github.com/Picrew/awesome-agent-harness)**: Curated list and engineering resources on deterministic wrappers (harnesses) for AI agents.
...
* **[qdrant (by qdrant)](https://github.com/qdrant/qdrant)**: High-performance production-ready vector similarity search engine database.
* **[chroma (by chroma-core)](https://github.com/chroma-core/chroma)**: Lightweight open-source embedding database for rapid AI prototyping.
...
* **[mcp-servers (by modelcontextprotocol)](https://github.com/modelcontextprotocol/servers)**: A collection of reference Model Context Protocol (MCP) servers.
* **[dspy (by stanfordnlp)](https://github.com/stanfordnlp/dspy)**: Programmatic prompt optimization and compilation framework for LLMs.
